...
const [,, rel, L, T, R, B] = process.argv;
const TARGET = { file: "public/" + rel, left: +L, top: +T, right: +R, bottom: +B };
const BACKUP = path.join("backup-images", rel);
...
(async () => {
  ...
  console.log(`${rel}: inpainted [${TARGET.left},${TARGET.top}]-[${TARGET.right},${TARGET.bottom})`);
